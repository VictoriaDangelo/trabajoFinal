class Pantallas {
  ...
  void dibujar(Juego j) {
    ...
    if (estado == "inicio") {//----------- Inicio 
      ...
      texto.btn2(37, width-150, height-150, 26);////Boton 26  = Continuar Aventura --> oro
    } else if (estado == "perder") {
      surface.setSize(550, 620);
      texto.mostrar(21);
      texto.textoDecision(32, width/2, height/2-50);
      texto.textoDecision(38, width/2, height/2+50);
      ...
      //---------------------------------------------------------------------------
    } else if (estado == "finalperder") { // FALTA TEXTO ---------------------------------------------------------------------------
      surface.setSize(800, 450);
      texto.mostrar(23);
      texto.textosd(34, 200, 290);
      texto.btn(28, width-100, height-50, 13);//Boton 23  = SIGUIENTE --> creditos
    } else if (estado == "oro") { 
      surface.setSize(800, 450);
      texto.mostrar(18);
